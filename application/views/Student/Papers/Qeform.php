...
$DocName = $this->debuger->ExamName($ExamType, $StudentType);
?>
<div class="col-md-12 col-sm-12 " style="text-align:right;margin-top:1%;" id="printArea">
<!-- <img src="< echo base_url();?>assets/img/formadviser.jpg" style="width:100%;"> -->
...
<tr>
 <td style="padding-top:10px;vertical-align:top">
     <b style="border:2px solid black; padding:10px;">บว.ทบ.08</b>
 </td>
 <td>
   <p id="rmu_logo" style="padding-top:30px"><img src="<?php echo base_url();?>/assets/img/rmu/rmu_logo.png"></p>
   <p id="appoint"><b>คำร้องขอสอบวัดคุณสมบัติ</b></p>

   <p id="appoint"><b>(Qualifying Examination)</b></p>
...
<tr>
<td style="text-align:left">
 เป็นนักศึกษาระดับ <label class="control-inline  custom-bgcolor-green">
     <input type="checkbox">
     <span style="font-size:12px">ปริญญาเอก</span>

   (
       <input type="checkbox">
       <span style="font-size:12px">แบบ 1.1</span>

         <input type="checkbox">
         <span style="font-size:12px">แบบ 1.2</span>

           <input type="checkbox">
           <span style="font-size:12px">แบบ 2.1</span>

             <input type="checkbox">
             <span style="font-size:12px;">แบบ 2.2</span>
           </label>)
...
<input type="text" class="underline" style="width:5%" value =" " disabled>และได้ชำระค่าสอบวัดคุณสมบัติ
...
<b>1.  อาจารย์ที่ปรึกษาวิทยานิพนธ์หลักตรวจคำร้องนี้แล้ว    เห็นควร</b>
...
<tr>
<td class="alignleft">
 อาจารย์ที่ปรึกษาวิทยานิพนธ์หลักลงนาม
 <input type="text" class="underline" style="width:5%" value =" " disabled>
</td>
 <td>
   (<input type="text" class="underline" style="width:5%" value =" " disabled>)
...
<td class="alignleft">
 เพราะว่า
 <input type="text" style="border:none;border-bottom:2px black dotted;width:5%" disabled>
</td>
</tr>
<tr>
<td class="alignleft">
 ...
 <td>
   วันที่<input type="text" style="border:none;border-bottom:2px black dotted;width:5%" disabled>
   เดือน<input type="text" style="border:none;border-bottom:2px black dotted;width:5%" disabled>
   พ.ศ.<input type="text" style="border:none;border-bottom:2px black dotted;width:5%" disabled>
 </td>
</tr>
...
<tr>
<td class="alignleft">
1. รองคณบดีบัณฑิตวิทยาลัย   ตรวจสอบคำร้องเสนอขอสอบวัดคุณสมบัติครั้งนี้แล้ว   เห็นควร
<input type="checkbox"> <span style="font-size:12px;">อนุมัติ</span>
<input type="checkbox"> <span style="font-size:12px;">ไม่อนุมัติ</span>
...
<tr>
<td class="alignleft">
ลายมือชื่อรองคณบดีบัณฑิตวิทยาลัย.......( .............)   วันที่ ..........เดือน........................พ.ศ. ...............
</td>
</tr>
<tr>
<td class="alignleft">
