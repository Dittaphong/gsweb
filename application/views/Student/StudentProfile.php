    ...
    <div class="row" >
		...
		<div class="col-md-5 col-sm-12" >
			<table border="0" width="100%">
				<tr>
					...
					<td align="left"><p style="padding: 5px;"><?=$Result['Student'][0]['STUDENTCODE'];?></p></td>
				</tr>
				<tr>
					<td align="right" width="50%"><p style="padding: 5px;"><b>ชื่อ-สกุล (ภาษาไทย) :</b></p></td>
					<td align="left"><p style="padding: 5px;"><?=$Result['Student'][0]['STUDENTNAME']."   ".$Result['Student'][0]['STUDENTSURNAME'];?></p></td>
				</tr>
				<tr>
					<td align="right" width="50%"><p style="padding: 5px;"><b>แผนการเรียน :</b></p></td>
					<td align="left"><p style="padding: 5px;"><?=$Result['Student'][0]['LEVELNAME'];?></p></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left"><p style="padding: 5px;"><?=$Result['Student'][0]['ADMITDATE'];?></p></td>
				</tr>
			</table>
		</div>
		<div class="col-md-5 col-sm-12" >
				...
				<tr>
					...
					<td align="left">
						<p style="padding: 5px;">
							...
							<?=$Result['Student'][0]['LEVELNAMECERTIFY'];?>
						</p>
					</td>
				</tr>
				<tr>
					<td align="right" width="50%"><p style="padding: 5px;"><b>ชื่อ-สกุล (ภาษาอังกฤษ) :</b></p></td>
					<td align="left"><p style="padding: 5px;"><?=$Result['Student'][0]['STUDENTNAMEENG']."   ".$Result['Student'][0]['STUDENTSURNAMEENG'];?></p></td>
				</tr>
				<tr>
					<td align="right" width="50%"><p style="padding: 5px;"><b>คณะ :</b></p></td>
					<td align="left"><p style="padding: 5px;"><?=$Result['Student'][0]['FACULTYNAME'];?></p></td>
				</tr>
				<tr>
					<td align="right" width="50%"><p style="padding: 5px;"><b>สาขา/แผนการศึกษา :</b></p></td>
					<td align="left"><p style="padding: 5px;"><?=$Result['Student'][0]['FACULTYABB'];?></p></td>
				</tr>
				<tr>
		...
		<div class="col-md-12 col-sm-12" style="text-align:center;margin-top:3%">
			...
			<div class="col-md-2 col-sm-4" id="ceqe_btn">
				...
				<span>
					<?php echo $Result['Student'][0]['LEVELID'] < 90 ? 'ขอสอบ<br />ประมวลผลความรู้' : 'ขอสอบวัดคุณสมบัติ' ;?>
				</span>
			</div>
			<div class="col-md-2 col-sm-4">
				...
				<span><?php echo $Result['Student'][0]['LEVELID'] < 90 ? 'ยื่นหัว<br />ข้อการค้นคว้าอิสระ' : 'ยื่นหัวข้อวิทยานิพนธ์' ;?></span>
			</div>
			<div class="col-md-2 col-sm-4">
				<div class="sidebar-minified " style="margin-left:-19%;margin-right:-19%;">
				<i >4</i>
				</div>
				<span><?php echo $Result['Student'][0]['LEVELID'] < 90 ? 'สอบเค้าโครง<br />การค้นคว้าอิสระ' : 'สอบเค้าโครงวิทยานิพนธ์' ;?></span>
			</div>
			<div class="col-md-2 col-sm-4">
				<div class="sidebar-minified " style="margin-left:-19%;margin-right:-19%;">
				<i >5</i>
				</div>
				<span><?php echo $Result['Student'][0]['LEVELID'] < 90 ? 'สอบการค้นคว้าอิสระ' : 'สอบวิทยานิพนธ์' ;?></span>
			</div>
			<div class="col-md-2 col-sm-4">
				<div class="sidebar-minified " style="margin-left:-19%;margin-right:-19%;">
				<i >6</i>
					...
					<div class="widget-content">
						...
						<table class="table table-bordered">
													...
													<tbody>
														...
														<?php foreach ($Result['Transcript'] as $value) {
														?>
														<tr>
									...
									<div class="col-md-4">
										<div class="contextual-summary-info contextual-background green-bg">
											...
											<p class="pull-right"><span style="font:18px bold;">เกรดเฉลี่ยรวม</span>
												<?php echo $Result['Student'][0]['GPA']%2==0 ?$Result['Student'][0]['GPA'].".00" : $Result['Student'][0]['GPA'] ;?>
											</p>
										</div>
									</div>
								</div>
