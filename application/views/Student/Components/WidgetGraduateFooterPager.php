...
<tr>
  ...
  <td>
   (<input type="text" class="underline" style="width:95%;text-align:center"
      value =" <?php isset($Result['Student'][0]['EMPLOYEEID']) ? $Result['Student'][0]['EMPLOYEEID'] : "";?>" disabled>)
  </td>
</tr>
...
<tr>
  <td class="alignleft"  colspan="3">
    <b>1.  อาจารย์ที่ปรึกษา<?php echo $Result['Student'][0]['LEVELID'] <90 ? "การค้นคว้าอิสระ" : "วิทยานิพนธ์";?>ตรวจคำร้องนี้แล้ว    เห็นควร</b><input type="checkbox"> <span style="font-size:12px;">อนุมัติ</span>
...
<tr>
  <td class="alignleft">
   อาจารย์ที่ปรึกษา<?php $Result['Student'][0]['LEVELID'] <90 ? "การค้นคว้าอิสระ" : "วิทยานิพนธ์";?>ลงนาม
...
<tr>
<td class="alignleft">
1. รองคณบดีบัณฑิตวิทยาลัย   ตรวจสอบคำร้องเสนอขอ<?php echo $DocName['NamePage'];?>ครั้งนี้แล้ว   เห็นควร
<input type="checkbox"> <span style="font-size:12px;">อนุมัติ</span>
<input type="checkbox"> <span style="font-size:12px;">ไม่อนุมัติ</span>
